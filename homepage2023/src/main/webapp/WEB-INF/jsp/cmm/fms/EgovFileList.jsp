    ...
    <li>
        <c:choose>
          <c:when test="${updateFlag=='Y'}">
             ...
             <span><c:out value="${fileVO.fileMg}"/></span>
             <span class='del'>
               <a href="#" class="file-del" data-id="${fileVO.atchFileId}" data-sn="${fileVO.fileSn}">
                   <img src="/asset/BBSTMP_0000000000001/imges/btn_sdelete.gif" alt="첨부된 파일 삭제">
               </a>
             </span>
           </c:when>
           <c:otherwise>
