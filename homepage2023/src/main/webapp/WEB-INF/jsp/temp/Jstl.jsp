...
<ul>
   <c:choose>
        ...
        <c:when test="${step eq '1'}">
			<li>
	           ...
	           <h4>기본문법 : &#60;c:out value="값" /&#62; </h4>
	            ...
	            JSP1번 : <%out.print("hello~");%> <br/>
	            JSP2번 : <%String a ="hello~";%>
	                    <%=a%> <br/>
	    ...
	    <c:when test="${step eq '2'}">
	        <li>
	            <h3>c:import Tag : jsp 'include' 와  유사. 서버 내부 또는 서버 외부의 모든 자원 컨탠츠를 포함하는 추가 기능이 있음</h3>
	          ...
	          <li>	             
	            ...
	            <h4>기본문법 : <br/>
	             &#60;c:choose&#62;<br/>
	               ...
	               &#60;c:otherwise"조건문"&#62;조건에 해당되지 않아서 나오는 내용  &#60;/c:otherwise&#62;</br>
	              &#60;c:choose&#62;
	             </h4>
	            
	            <c:set var="test" value="0"/>
	           <c:choose>
	               <c:when test="${step eq '1'}">1입니다. </c:when>
