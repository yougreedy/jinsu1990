...
<script src="https://cdn.tiny.cloud/1/klkffga8q2r3qwhn682h63cevp94z4wmp3sewtvx8dc4gm8r/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
...
<c:url var="_BASE_PARAM" value="">
     ...
     <c:if test="${not empty searchVO.searchCondition}"><c:param name="searchContion" value="${serachVO.searchContion}"/></c:if>
     <c:if test="${not empty searchVO.searchKeyword}"><c:param name="searchKeyword" value="${serachVO.searchKeyword}"/></c:if>
</c:url>
