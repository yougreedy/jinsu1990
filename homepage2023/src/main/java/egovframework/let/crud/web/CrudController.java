...
public class CrudController {
  ...
  public String selectList (CrudVO crudVO , HttpServletRequest requset, ModelMap model) throws Exception{
   ...
   public String select (CrudVO crudVO , HttpServletRequest requset, ModelMap model) throws Exception{
